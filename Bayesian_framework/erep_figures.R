...
#
#   erep_tension.{pdf,png}     the tension between the two directional rates
...
lab_a <- expression(epsilon[rep]^{"present"} ~ "(false negative)",
                    epsilon[rep]^{"absent"} ~ "(false positive)",
                    "maximum of the two")
...
print(fig1)
ggsave("erep_tension.pdf", fig1, width = fig_w, height = fig_h)
ggsave("erep_tension.png", fig1, width = fig_w, height = fig_h, dpi = fig_dpi)
...
cat("Wrote erep_tension.{pdf,png} and evidential_weight.{pdf,png}\n")
